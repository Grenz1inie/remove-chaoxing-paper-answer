...
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/config.js
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/core/logger.js
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/core/url-parser.js
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/core/database-manager.js
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/ui/styles/style-generator.js
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/ui/components/dom-helper.js
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/ui/components/note-editor.js
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/ui/components/control-panel.js
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/controllers/answer-block-controller.js
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/controllers/global-controller.js
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/app.js
// @run-at       document-end
// @license MIT
