...
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/config.js?v=3.12.0.3
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/core/logger.js?v=3.12.0.3
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/core/url-parser.js?v=3.12.0.3
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/core/database-manager.js?v=3.12.0.3
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/ui/styles/style-generator.js?v=3.12.0.3
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/ui/components/dom-helper.js?v=3.12.0.3
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/ui/components/note-editor.js?v=3.12.0.3
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/ui/components/control-panel.js?v=3.12.0.3
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/controllers/answer-block-controller.js?v=3.12.0.3
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/controllers/global-controller.js?v=3.12.0.3
// @require      https://cdn.jsdelivr.net/gh/Grenz1inie/remove-chaoxing-paper-answer@dev/src/app.js?v=3.12.0.3
// @run-at       document-end
// @license MIT
